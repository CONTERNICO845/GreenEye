...
public class cuenta extends JPanel {
    ...
    public cuenta() {
        ...
        if (Configuracion.esModoObscuro == true){
        topPanel.setBackground(AppColors.COLOR_DARK_BUTTONS);    
        }
        ...
        if (Configuracion.esModoObscuro == true){
        lblTitulo.setForeground(AppColors.COLOR_DARK_BLUE);
        }   
        ...
        if (Configuracion.esModoObscuro == true){
        lblSubtitulo.setForeground(AppColors.COLOR_DARK_BLUE);
        }  
        ...
        if (Configuracion.esModoObscuro == true){
        centerPanel.setBackground(AppColors.COLOR_DARK_BUTTONS);
        centerPanel.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createTitledBorder(
                        BorderFactory.createLineBorder(AppColors.COLOR_DARK_BUTTONS, 2), // Color de la línea en modo oscuro
                        " Mis Estadísticas de Reciclaje ", 
                        0, 0, 
                        new Font("Arial", Font.BOLD, 14),
                        AppColors.COLOR_DARK_BLUE  
                ), 
                BorderFactory.createEmptyBorder(10, 10, 10, 10)
            ));
        }  
